...
/******/ 	(() => {
/******/ 		const inProgress = {};
/******/ 		const dataWebpackPrefix = "ruffle-extension:";
...
/******/ 		}
/******/ 		
/******/ 		const chunkLoadingGlobal = self["webpackChunkruffle_extension"] = self["webpackChunkruffle_extension"] || [];
...
const buildInfo = {
    ...
    buildDate: "2026-08-03T22:27:09.537Z",
    commitHash: "a4f5b5256e245693bc9077ef6c6b6abc95490e7f",
};
...
const BUNDLED_TEXTS = {
  ...
  "nb-NO": {
    ...
    "messages.ftl": "",
    "save-manager.ftl": "save-delete-prompt = Er du sikker på at du vil slette filen?\nsave-download = Last ned\nsave-replace = Erstatt\nsave-delete = Slett\n",
...
class LoadBeginError extends Error {
    constructor(message) {
...
function showPanicScreen(container, error, errorArray, swfUrl) {
    ...
    const detailsModal = (0,dist.createRef)();
    const copyButton = (0,dist.createRef)();
    const showDetails = () => {
        detailsModal.current.classList.remove("hidden");
    };
    container.textContent = "";
    container.appendChild((0,jsx_runtime.jsxs)("div", { id: "panic", children: [(0,jsx_runtime.jsx)("div", { id: "panic-title", children: i18n_text("panic-title") }), (0,jsx_runtime.jsx)("div", { id: "panic-body", children: body }), (0,jsx_runtime.jsx)("div", { id: "panic-footer", children: (0,jsx_runtime.jsx)("ul", { children: actions.map((action) => createPanicAction({
                        action,
                        showDetails,
                        errorText,
                        errorArray,
                        swfUrl,
                    })) }) }), (0,jsx_runtime.jsx)("div", { id: "panic-details-modal", class: "hidden", ref: detailsModal, children: (0,jsx_runtime.jsxs)("div", { id: "panic-details-content", children: [(0,jsx_runtime.jsx)("span", { class: "panic-copy-button", title: "Copy to clipboard", ref: copyButton, onClick: () => {
                            ...
                            } }), (0,jsx_runtime.jsx)("span", { class: "close-modal", onClick: () => detailsModal.current.classList.add("hidden") }), (0,jsx_runtime.jsx)("textarea", { readOnly: true, children: errorText })] }) })] }));
}
...
;// ../core/dist/internal/polyfill-document-embeds.js
/**
 ...
 */
function mergeSorted(a, b, comparator) {
    const result = [];
    let i = 0;
    let j = 0;
 ...
 */
function getSelector(tries) {
    const selectors = ["ruffle-embed"];
    ...
    Object.defineProperty(Document.prototype, "embeds", {
        get() {
            ...
            const getFreshNodes = () => {
                ...
                const baseEmbeds = orig.get.call(this);
                const selector = getSelector(tries);
                const ruffleEmbeds = Array.from(this.querySelectorAll(selector));
                // Per https://dom.spec.whatwg.org/#interface-htmlcollection, sorted in tree order
                return mergeSorted(Array.from(baseEmbeds), ruffleEmbeds, domComesBefore);
            };
            const nodes = () => {
                if (cachedNodes !== null) {
                    return cachedNodes;
            ...
            const base = Object.create(HTMLCollection.prototype);
...
class InnerPlayer {
    ...
    async load(options, isPolyfillElement = false) {
        ...
        try {
            ...
            const err = new LoadBeginError(e);
            this.panic(err);
            throw err;
        }
    }
    ...
    showContextMenu(event) {
        ...
        const hasCheckmarks = items.some((item) => item !== null && item.checked !== undefined);
        this.contextMenuElement.classList.toggle("has-checkmarks", hasCheckmarks);
